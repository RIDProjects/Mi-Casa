...
import { LayoutDashboard, Users, ShieldCheck, CreditCard, Package, ShoppingCart, PiggyBank, LogOut } from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white flex flex-col min-h-screen">
      <div className="p-6 border-b border-gray-700">
        ...
        <p className="text-xs text-gray-400 mt-1">Sistema financiero</p>
      </div>
