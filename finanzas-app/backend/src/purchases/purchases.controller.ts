...
export class PurchasesController {
  ...
  addItem(@Param('listId') listId: string, @Body() dto: any) { return this.purchasesService.addItem(listId, dto); }

  @Put('items/:id') @RequirePermission('purchases', 'edit')
  updateItem(@Param('id') id: string, @Body() dto: any) { return this.purchasesService.updateItem(id, dto); }
